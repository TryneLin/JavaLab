...
//		Food item5 = (Food)item; // 保證 Pproduct 一定是 Notebook
		...
		// Date取得方式: 先知道要用哪一種日曆
		GregorianCalendar calendar = new GregorianCalendar(2022, 3, 18);//月份由0起算
		GregorianCalendar calendar1 = new GregorianCalendar(2022, Calendar.JANUARY, 18);//月份由0起算,或是用Calendar指定月份
